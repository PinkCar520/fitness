...
struct PlanHistoryView_Previews: PreviewProvider {
    static var previews: some View {
        ...
        let mockPlan1 = Plan(name: "30天减脂计划", goal: .fatLoss, startDate: Calendar.current.date(byAdding: .month, value: -2, to: Date())!, duration: 30, tasks: [], status: "archived")
        let mockPlan2 = Plan(name: "14天增肌计划", goal: .muscleGain, startDate: Calendar.current.date(byAdding: .month, value: -1, to: Date())!, duration: 14, tasks: [], status: "archived")
